...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "hover_expand_delay_desc": "How long to wait before expanding the panel when hovering over the notch (0 = instant)",
        "shortcuts": "Shortcuts",
        ...
        "relay_server": "Forwarding Server",
        "relay_server_desc": "Monitor remote agents through a self-hosted forwarding server. This works alongside SSH remote hosts.",
        "relay_server_url": "Server URL",
        "relay_api_key": "API Key",
        "relay_auto_connect": "Auto-connect Forwarding Server on Launch",
        "relay_register": "Register / Get API Key",
        "relay_copy_api_key": "Copy API Key",
        "relay_copy_install_command": "Copy Install Command",
        "relay_install_command": "Remote install command",
        "relay_install_command_empty": "Enter server URL and API Key first.",
        "relay_remote_config_path": "Remote config file: ~/.codeisland/relay.json",
        ...
        "automatic_update_homebrew_disabled": "Updates are managed by Homebrew.",
    ...
    private static let zh: [String: String] = [
        ...
        "hover_expand_delay_desc": "鼠标悬停在刘海上后等待多久才展开面板（0 = 立即展开）",
        "shortcuts": "快捷键",
        ...
        "relay_server": "转发服务器",
        "relay_server_desc": "通过自托管转发服务器监控远程 agent，可与 SSH 远程主机功能并存。",
        "relay_server_url": "服务器地址",
        "relay_api_key": "API Key",
        "relay_auto_connect": "启动时自动连接转发服务器",
        "relay_register": "注册 / 获取 API Key",
        "relay_copy_api_key": "复制 API Key",
        "relay_copy_install_command": "复制安装命令",
        "relay_install_command": "远端安装命令",
        "relay_install_command_empty": "请先填写服务器地址并设置 API Key。",
        "relay_remote_config_path": "远端配置文件：~/.codeisland/relay.json",
        "remote_hosts": "远程主机",
        ...
        "automatic_update_checks": "自动检查更新",
        "automatic_update_homebrew_disabled": "更新由 Homebrew 管理。",
    ...
    private static let ja: [String: String] = [
        ...
        "haptic_medium": "中",
        "haptic_strong": "強",
        "hover_expand_delay": "ホバー展開の遅延",
        "hover_expand_delay_desc": "ノッチにホバーしてからパネルが展開するまでの待ち時間（0 = 即時）",
        "shortcuts": "ショートカット",
        ...
        "relay_server": "転送サーバー",
        "relay_server_desc": "セルフホストの転送サーバー経由でリモート agent を監視します。SSH リモートホストと併用できます。",
        "relay_server_url": "サーバー URL",
        "relay_api_key": "API Key",
        "relay_auto_connect": "起動時に転送サーバーへ自動接続",
        "relay_register": "登録 / API Key を取得",
        "relay_copy_api_key": "API Key をコピー",
        "relay_copy_install_command": "インストールコマンドをコピー",
        "relay_install_command": "リモートインストールコマンド",
        "relay_install_command_empty": "先にサーバー URL と API Key を入力してください。",
        "relay_remote_config_path": "リモート設定ファイル: ~/.codeisland/relay.json",
        ...
        "automatic_update_checks": "アップデートを自動確認",
        "automatic_update_homebrew_disabled": "アップデートは Homebrew で管理されます。",
    ...
    private static let ko: [String: String] = [
        ...
        "haptic_medium": "중간",
        "haptic_strong": "강함",
        "hover_expand_delay": "호버 확장 지연",
        "hover_expand_delay_desc": "노치 위에 마우스를 올린 후 패널이 확장되기까지 대기 시간 (0 = 즉시)",
        "shortcuts": "단축키",
        ...
        "relay_server": "전달 서버",
        "relay_server_desc": "직접 호스팅한 전달 서버를 통해 원격 agent를 모니터링합니다. SSH 원격 호스트와 함께 사용할 수 있습니다.",
        "relay_server_url": "서버 URL",
        "relay_api_key": "API Key",
        "relay_auto_connect": "시작 시 전달 서버에 자동 연결",
        "relay_register": "등록 / API Key 받기",
        "relay_copy_api_key": "API Key 복사",
        "relay_copy_install_command": "설치 명령 복사",
        "relay_install_command": "원격 설치 명령",
        "relay_install_command_empty": "먼저 서버 URL과 API Key를 입력하세요.",
        "relay_remote_config_path": "원격 설정 파일: ~/.codeisland/relay.json",
        "remote_hosts": "원격 호스트",
        ...
        "automatic_update_checks": "업데이트 자동 확인",
        "automatic_update_homebrew_disabled": "업데이트는 Homebrew에서 관리합니다.",
    ...
    private static let tr: [String: String] = [
        ...
        "haptic_medium": "Orta",
        "haptic_strong": "Güçlü",
        "hover_expand_delay": "Genişleme Gecikmesi",
        "hover_expand_delay_desc": "Çentik üzerine geldiğinizde panelin genişlemesi için bekleme süresi (0 = anında)",
        ...
        "relay_server": "Aktarma Sunucusu",
        "relay_server_desc": "Kendi barındırdığınız aktarma sunucusu üzerinden uzak agent oturumlarını izleyin. SSH uzak hostlarıyla birlikte çalışır.",
        "relay_server_url": "Sunucu URL'si",
        "relay_api_key": "API Key",
        "relay_auto_connect": "Başlangıçta aktarma sunucusuna otomatik bağlan",
        "relay_register": "Kaydol / API Key al",
        "relay_copy_api_key": "API Key'i Kopyala",
        "relay_copy_install_command": "Kurulum Komutunu Kopyala",
        "relay_install_command": "Uzak kurulum komutu",
        "relay_install_command_empty": "Önce sunucu URL'sini ve API Key'i girin.",
        "relay_remote_config_path": "Uzak yapılandırma dosyası: ~/.codeisland/relay.json",
        ...
        "automatic_update_checks": "Güncellemeleri otomatik kontrol et",
        "automatic_update_homebrew_disabled": "Güncellemeler Homebrew tarafından yönetilir.",
